            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                	<div class="panel-actions">
                        		<button type="button" class="btn btn-info btn-sm pull-right" data-toggle="modal" data-target="#myModal" >Ajouter</button>
                    </div></br></br>
                            	...
                            	<table id="basic-datatables" class="table table-striped">
				                               ...
				                               %>
                                                        <tr>
															...
															<td><a href="listInd.chu?id=<%=famille.getId()%>"> <i class="fa fa-eye" > </i> Consulter </a> <a  href="modFamille.chu?id=<%=famille.getId()%>" ><i class="fa fa-pencil-square-o"></i> Modifier </a>  <a href="arbre.jsp"><i class="fa fa-eye"></i> Arbre Genealogique</a></td>
                                                        </tr>
