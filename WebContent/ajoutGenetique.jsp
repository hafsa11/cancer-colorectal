				...
				<div class="row">
                        <div class="col-sm-12">
                        	...
                        	<div class="panel panel-default">
								<div class="panel-heading"><h3 class="panel-title">Examen Genetique</h3></div>
								<form class="form-horizontal" role="form" action="ajoutGenetique.chu" method="post">
                                    <div class="row">
										...
										<div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <label for="dateexamen" class="col-sm-4 form-control-label">Numero de dossier genetique:</label>
                                                
                                                  <input type="text" name="numero" placeholder="" class="form-control" id="" style="width:250px" required>
                                                
                                            </div>
                                             <div class="form-group">
	                                                <label class="col-sm-4 form-control-label">Instabilité des microsatellites:</label>
	                                                <div class="col-sm-8">
	                                                    <select class="form-control" name="instabiliteMacroscopique" style="width:250px">
                                             ...
                                             <div class="form-group">
	                                                <label class="col-sm-4 form-control-label">Mutation VC00E du gène BRAF:</label>
	                                                <div class="col-sm-8">
	                                                    <select class="form-control" name="mutaBRAF" style="width:250px">
											...
											<div class="form-group">
	                                                <label class="col-sm-4 form-control-label">Mutation du gène K-ras:</label>
	                                                <div class="col-sm-8">
	                                                    <select class="form-control" name="mutaKras" style="width:250px">
                                            ...
                                            <div class="form-group">
	                                                <label class="col-sm-4 form-control-label">Mutation du gène APC:</label>
	                                                <div class="col-sm-8">
	                                                    <select class="form-control" name="mutaAPC" style="width:250px">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-sm-4 form-control-label">Mutation du gène MYH:</label>
	                                                <div class="col-sm-8">
	                                                    <select class="form-control" name="mutaMYH" style="width:250px">
                                            ...
                                            <div class="form-group">
													<label for="" class="col-sm-5 col-sm-offset-0 form-control-label"> Mutation du gène MMR: </label>
													<div class="checkbox checkbox-info checkbox-circle col-sm-8 col-sm-offset-4">
													 <%
													 MutaMMRDAO mutaDAO = new MutaMMRDAO();
											            	List<MutaMMR> mutations = new ArrayList<>();
											            	mutations=mutaDAO.listerMutaMMR();
											           
				                                			for(MutaMMR muta : mutations ){
				                                		%>
														<input  type="checkbox"  name="mutaMMR" value ="<%=muta.getId() %>">
														<label for="syndrome">
															<%=muta %> 
														</label>
																<label>
																  <input type="radio" name="mutaMMRoui" id=""  >
																  <%=Resultat.OUI %>
																</label>
																<label>
																  <input type="radio" name="mutaMMRnon" id=""  >
																   <%=Resultat.NON %>
																</label>
																<label>
																  <input type="radio" name="mutaMMRvsi" id=""  >
																   <%=Resultat.VSI %>
																</label>
												...
												<div class="form-group">
                                                <label for="dateexamen" class="col-sm-2 col-sm-offset-2 form-control-label">Autre:</label>
                                                
                                                  <input type="text" name="autre" placeholder="" class="form-control" id="" style="width:250px" required>
