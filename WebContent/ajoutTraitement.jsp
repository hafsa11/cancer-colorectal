				...
				<div class="row">
                        <div class="col-sm-12">
                        	...
                        	<div class="panel panel-default">
								...
								<form class="form-horizontal" role="form" action="ajoutTraitement.chu" method="post">
                                    <div class="row">
										...
										<div class="panel-body">
		                                    ...
		                                    <div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="dateTrait" id="" placeholder="jj/mm/aaaa" style="width:250px">
	                                            </div>
		                                    <div class="form-group">
	                                    ...
	                                    <div class="panel-body">
	                                    	...
	                                    	<div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="date" id="" placeholder="jj/mm/aaaa" style="width:250px">
	                                            </div>
	                                       	<div class="form-group">
	                                                <label for="" class="col-sm-4 control-label" >Service:</label>
	                                                <input type="text" class="form-control" name="service"  placeholder="service" style="width:250px">
	                                            </div>
	                                    ...
	                                    <div class="panel-body">
											  <div class="form-group">
												...
												<div class="form-group">
	                                                ...
	                                                <input type="text" class="form-control" name="dateDebutChim" id="" placeholder="jj/mm/aaaa" style="width:250px">
	                                            </div>
	                                            <div class="form-group">
	                                                <label for="" class="col-sm-4 control-label" >Date de fin:</label>
	                                                <input type="text" class="form-control" name="dateFinChim" id="" placeholder="jj/mm/aaaa" style="width:250px">
	                                            </div>
	                                    ...
	                                    <div class="panel-body">
	                                    	<div class="form-group">
												...
												<div class="form-group">
	                                                <label for="" class="col-sm-4 control-label" >Date de début :</label>
	                                                <input type="text" class="form-control" name="dateDebutRad" id="" placeholder="jj/mm/aaaa" style="width:250px">
	                                            </div>
	                                            <div class="form-group">
	                                                <label for="" class="col-sm-4 control-label" >Date de fin:</label>
	                                                <input type="text" class="form-control" name="dateFinRad" id="" placeholder="jj/mm/aaaa" style="width:250px">
	                                            </div>
	                                    </div>
										</br></br>
