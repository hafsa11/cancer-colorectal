			...
			<div class="row">
                <div class="col-md-10 col-lg-offset-1">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h3 class="panel-title">Liste des individus</h3></div>
                        <%
                            	...
                            	<table class="table table-striped">
				                               ...
				                               %>
                                                        <tr>
                                                            ...
                                                            <td><%=ind.getPrenom()%></td> 
                                                            <td><%=dateFormatee%></td>
															<td><a href="dossier.chu?id=<%=ind.getId()%>"><i class="fa fa-pencil-square-o"></i> Ajouter Dossier</a></td>
                                                        </tr>
													...
													<% 
				                               			...
				                               			<tr>
                                                            ...
                                                            <td><%=ind.getPrenom()%></td> 
                                                            <td><%=dateFormatee%></td>
															<td><a href="modifier.chu?id=<%=ind.getDossier().getId()%>"><i class="fa fa-pencil-square-o"></i> Modifier Dossier</a> <a href="examen.chu?id=<%=ind.getDossier().getId()%>"><i class="fa fa-eye" > </i> Consulter Dossier</a></td>
                                                        </tr>
				                               			<% 
				                               		}
													i++;
