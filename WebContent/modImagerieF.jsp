				...
				<div class="row">
                        <div class="col-sm-12">
                        	...
                        	<div class="panel panel-default">
								...
								<form class="form-horizontal" role="form" action="modImagerieTrait.chu" method="post" enctype="multipart/form-data">
                                    <div class="row">
										...
										<div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                ExamenImagerieDAO examenDAO = new ExamenImagerieDAO();
											            ...
											            %>
                                                    <select class="form-control" name="examen" style="width:250px" required>
                                                       <% 
                                            ...
                                            <div class="form-group">
                                                <label for="dateexamen" class="col-sm-4 form-control-label">Date d'examen:</label>
                                                  ...
                                                  <input type="text" name="dateImagerie" placeholder="jj/mm/aaaa" class="form-control" id="dateexamen" style="width:250px" required>
                                                
                                            </div> 
											<div class="form-group">
                                                <label for="poids" class="col-sm-2 form-control-label" >Fichier</label>
                                                <input type="file" class="form-control" name="fichier" id=""  required >
                                            </div>
