			    ...
			    <div id="menu2" class="tab-pane fade">
			      ...
			      <div class="col-md-10 col-md-offset-1">
                        	...
                        	<%
									...
									%>
							<div class="panel-actions">
                        			<button type="button" class="btn btn-info btn-sm pull-right" onclick="location.href='ajoutEndoscopie.chu?id=<%=dos.getId()%>'" >Ajouter</button>
                    			</div></br></br>
                        	<div class="panel panel-default">
                                            ...
                                            <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                    	<td>Examen endoscopique</td>
                                                     	<td>du <%=dateFormatee%></td> 
                                                     	<td><a href="consEndoscopieNormal.chu?id=<%=e.getId()%>" ><button type="button" class="btn btn-info btn-custom waves-effect waves-light m-b-5" style="width:250px"  >Consulter</button></a></td> 
