				...
				<div class="row">
                        <div class="col-sm-12">
                        	...
                        	<div class="panel panel-default">
								...
								<form class="form-horizontal" role="form" action="ajoutExamenClinique.chu" method="post">
                                    <div class="row">
										...
										<div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="dateexamen" placeholder="jj/mm/aaaa" class="form-control" id="dateexamen" style="width:250px" required>
                                                </div>
                                            </div> 
											<div class="form-group">
                                                <label for="poids" class="col-sm-2 form-control-label" >poids</label>
                                                <input type="text" class="form-control" name="poids" id="poids" placeholder="Le poids"  style="width:250px" required >
                                            </div>
											<div class="form-group">
                                                <label for="taille" class="col-sm-2 form-control-label">Taille</label>
                                                <input type="text" class="form-control" name="taille" id="taille" placeholder="La taille"  style="width:250px" required>
                                            </div>
											<div class="form-group">
                                                <label for="oms" class="col-sm-2 form-control-label" >OMS</label>
                                                <input type="text" class="form-control" name="oms" id="oms" placeholder="OMS"  style="width:250px" required>
                                            </div>
											<div class="form-group">
                                                <label for="imc" class="col-sm-2 form-control-label">IMC</label>
                                                <input type="text" class="form-control" name="imc" id="imc" placeholder="IMC"  style="width:250px" required >
                                            </div>			
										</div>
										</div>
									<div class="row">
