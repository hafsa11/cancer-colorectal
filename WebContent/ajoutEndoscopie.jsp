	...
	<div class="container">
		<div    class="row" >
			...
			<div class="row">
                ...
                <form class="form-horizontal" role="form" action="ajoutEndoscopie.chu" method="post">
                <div class="row">
		                                    ...
		                                    <div class="form-group">
		                                         <input type="hidden" class="form-control" name="dossier" value="<%=dos.getId()%>"  style="width:250px" >
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="numero" id="numero" placeholder=""  style="width:250px" required>
													</div>
												 <div class="form-group">
