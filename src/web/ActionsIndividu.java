...
//		String urb = request.getParameter("urbain");
		...
		Individu individu = new Individu(prenom, nom , dateNais, sexe, urbain, ville, region, adresse, origine, tel1, tel2, education, occupation, niveauSocial, couvertMedicale, famille);
